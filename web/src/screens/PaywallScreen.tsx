...
// Что входит в «Дачник Про» сверх бесплатного тарифа (до 3 посадок — без ограничения по времени).
const BENEFITS = [
...
export default function PaywallScreen() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-4">
      ...
      {/* Раньше здесь фигурировало «1 сад/участок» — рядом с «Что входит» это читалось так, будто
          Про даёт больше и участков тоже (жалоба владельца 2026-08-14). Участков в продукте всегда
          один, упоминать их количество незачем — оставлен только реальный лимит, который меняется. */}
      {!hasAccess && (
        <div className="dacha-card flex items-center gap-2 bg-tertiary/10 p-4 font-bold text-tertiary">
          ...
          Бесплатно навсегда: без карты и без рекламы. Сейчас доступно до {plantingsLimit} посадок одновременно.
        </div>
      )}
