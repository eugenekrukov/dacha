...
export default function PaywallScreen() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col gap-4">
      ...
      {/* Явно разводим сад и посадки: фраза выше «1 сад и N посадок» рядом с «Что входит» читалась
          так, будто Про даёт больше и садов тоже — участок всегда один, лимит снимается только
          на посадки (жалоба владельца 2026-08-14). */}
      <p className="text-sm font-semibold text-muted">
        Участок всегда один — и на бесплатном тарифе, и на «Дачник Про». Лимит «Дачник Про» снимает
        только на число посадок.
      </p>
