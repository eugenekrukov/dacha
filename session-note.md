...
**ЕДИНСТВЕННЫЙ незакрытый шаг**: пересборка APK с `main` (`e54ae43`) + проверка на устройстве
(промокоды: ввод/тост/статус в настройках/клавиатура/Купить; архив сезонов).
