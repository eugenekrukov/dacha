...
//   С 2026-09 блог — основной канал: заголовок поста ("## ... — Заголовок") пишется сразу в
//   формулировке поискового запроса, SEO: для новых постов не нужен (слаг всё равно берётся от
//   заголовка поста и после публикации не меняется). Секция осталась для старых постов с
//   заголовком-хуком. Используется для <title>/H1/JSON-LD блога, см. generate-blog.js.
//   Правила написания статей — docs/blog-content-guide.md.
//
