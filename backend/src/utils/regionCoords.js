...
const REGION_ZONE = {
  ...
  // Зона 3, а не 4: зимние минимумы регулярно уходят ниже −35 °C, а сезон работ начинается
  // заметно позже, чем на Урале. Подтверждено владельцем дачи под Новосибирском (2026-08-12):
  // к весенней обрезке смородины приступают в середине-конце апреля.
