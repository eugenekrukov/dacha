...
**⚠️ ПЕРЕСОБРАТЬ AAB перед публикацией vc11** (2026-07-30, `020c600` → `d4f38e5`): on-device QA
семян дал четыре правки, все внесены.
...
Если AAB собран до `933e1a4` — собрать заново.
