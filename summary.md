...
**⚠️ ПЕРЕСОБРАТЬ AAB перед публикацией vc11** (2026-07-30, `020c600` + `ddd779d`): on-device QA
семян нашёл три дефекта UI, все исправлены.
...
Если AAB собран до `ddd779d` — собрать заново.
