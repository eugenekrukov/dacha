...
**🚧 Готовится к публикации: versionCode 10→11, versionName 1.0.7→1.0.8** (тёмная тема — тумблер
«Система/Светлая/Тёмная» + фикс контраста карточек, сессия 2026-07-27). Сборку AAB и публикацию
делает владелец вручную.
