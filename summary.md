...
- Известный пробел (НЕ закрыт): 27 культур без care_tasks (бахчевые, поздние капусты, зелень, ягоды) —
  расписание у них только полив + пересадка + урожай. Бэклог: засеять care_tasks.
