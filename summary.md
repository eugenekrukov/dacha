...
Закрыто (пометки в старых редакциях устарели): грядки/севооборот UI ✅ (2026-07-01), P5 изображения ✅,
хвост фото справочника — почти ✅ (**5 записей из 78 без фото**, а не ~16).
