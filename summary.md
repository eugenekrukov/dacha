...
вместо 7-дневного триала** (главное изменение — см. «Монетизация» выше, сессия 2026-07-18) + фикс
переноса лейбла «Календарь» в нижнем меню (`ae0f6c2`). Версия единая для Gplay и RuStore — оба
магазина сейчас на одной волне, отдельных текстов на два магазина больше не нужно. Тексты release
notes — `session-note.md` (2026-07-18 (2)).
