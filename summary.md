...
**📌 НЕ ЗАДЕПЛОЕН лендинг** (правка 2026-07-30): в `landing/index.html` исправлена заниженная
цифра «45+ культур» → «55 культур» в 7 местах, включая `meta description`, og/twitter и
FAQ-схему. В git есть (`5402b7a`), на сайте ещё нет. Выкладка — `docs/DEPLOY.md` («Лендинг»).
