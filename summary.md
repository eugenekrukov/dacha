...
### ⏳ Незакрытые шаги
- [x] 🔑 Секретный ключ ЮKassa перевыпущен (старый засветился в чате) и вписан в `backend/.env` на VPS.
- [ ] **E4 финал**: вебхук в кабинете ЮKassa + смоук-тест create-payment + пересборка APK + боевой платёж.
